  ...
  return (
    <main className="login-page relative min-h-screen overflow-hidden bg-brokenshire-900">
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-8 sm:px-8">
        <section className="login-card relative w-full max-w-[460px] rounded-[22px] border p-8 text-center shadow-2xl sm:p-10">
          <div className="mb-8 flex items-center justify-center gap-2.5">
            <img src="/Clinova.png" alt="CLINOVA logo" width="34" height="34" className="h-9 w-9 rounded-full object-contain" />
            <p className="text-base font-semibold tracking-tight text-white">CLINOVA</p>
          </div>
          ...
          <p className="mx-auto mt-3 max-w-sm text-[13px] leading-6 text-emerald-50/75">
            {success ? 'Your CLINOVA account is confirmed and ready to use.' : 'This activation link is invalid or has expired. Request a new signup link to continue.'}
          </p>
          ...
          <div className="mt-6 flex items-start gap-2.5 rounded-xl border border-white/15 bg-black/10 px-3.5 py-3 text-left text-[11px] leading-4 text-emerald-50/75">
            ...
            <span>CLINOVA protects health information through verified accounts and role-based access.</span>
          </div>
          <p className="mt-7 text-[11px] text-emerald-50/50">© 2026 CLINOVA · Private clinic information system</p>
        </section>
      </div>
    </main>
  );
